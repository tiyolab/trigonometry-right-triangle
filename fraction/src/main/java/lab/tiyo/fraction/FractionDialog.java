 ...
 */
public class FractionDialog extends DialogFragment {
     ...
     */
    private View fractionDialogLayout;
     ...
     * define listener
     */
    FractionDialogListener listener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
         ...
         * get view
         */
        fractionDialogLayout = inflater.inflate(R.layout.fraction_dialog, null);

        firstFractionContainer = (FrameLayout)fractionDialogLayout.findViewById(R.id.first_fraction_container);
        firstFractionInteger = (EditText)fractionDialogLayout.findViewById(R.id.first_fraction_integer);
        firstFractionRoot = (EditText)fractionDialogLayout.findViewById(R.id.first_fraction_root);

        secondFractionContainer = (FrameLayout)fractionDialogLayout.findViewById(R.id.second_fraction_container);
        secondFractionInteger = (EditText)fractionDialogLayout.findViewById(R.id.second_fraction_integer);
        secondFractionRoot = (EditText)fractionDialogLayout.findViewById(R.id.second_fraction_root);

        numberType1 = (Button)fractionDialogLayout.findViewById(R.id.numberType1);
        numberType2 = (Button)fractionDialogLayout.findViewById(R.id.numberType2);
        numberType3 = (Button)fractionDialogLayout.findViewById(R.id.numberType3);

        numberTypeGroup = (RadioGroup)fractionDialogLayout.findViewById(R.id.number_type_group);
        integersType = (RadioButton)fractionDialogLayout.findViewById(R.id.integers_type);
        fractionsType = (RadioButton)fractionDialogLayout.findViewById(R.id.fractions_type);
        integersContainer = (RelativeLayout)fractionDialogLayout.findViewById(R.id.integers_container);
        fractionsContainer = (RelativeLayout)fractionDialogLayout.findViewById(R.id.fractions_container);
        integerValue = (EditText)fractionDialogLayout.findViewById(R.id.integer_value);
         ...
         */
        dialog.setView(fractionDialogLayout);
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(integersType.isChecked()){
                    if(!integerValue.getText().toString().isEmpty()){
                        ...
                        //tNumber.setIntegerNumber(Double.parseDouble(integerValue.getText().toString()));
                    }else{
        ...
        dialog.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                FractionDialog.this.getDialog().cancel();
            }
        });
    ...
    public void setFractionDialogListener(FractionDialogListener listener){

 ...
 */
public class DescriptionItemAdapter extends BaseAdapter{
    private ArrayList<ItemDescriptionDialog> listItems = new ArrayList<>();
    private Activity activity;
    private LayoutInflater layoutInflater;

    public DescriptionItemAdapter(Activity activity, ArrayList<ItemDescriptionDialog> listItems){
    ...
    public View getView(int index, View convertView, ViewGroup viewGroup) {
        ...
        if(itemView == null){
            itemView = layoutInflater.inflate(R.layout.item_description, null);

            ViewHolder holder = new ViewHolder();
            holder.itemName = (TextView)itemView.findViewById(R.id.item_name);
            holder.itemValue = (FractionView)itemView.findViewById(R.id.item_value);
        ...
        holder.itemValue.setNumber(listItems.get(index).getTNumber());

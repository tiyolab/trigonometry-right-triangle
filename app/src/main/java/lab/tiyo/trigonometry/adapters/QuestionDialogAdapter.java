...
public class QuestionDialogAdapter extends BaseAdapter {
    ...
    public QuestionDialogAdapter(Activity activity, ArrayList<ItemDescriptionDialog> listItems){
    ...
    public View getView(final int index, View convertView, ViewGroup viewGroup) {
        ...
        if(itemView == null){
            itemView = layoutInflater.inflate(R.layout.item_question_dialog, null);
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (listener != null) {
                    listener.onClick(listItems.get(index));
                }
            }
        });
        return itemView;
